...
const NavBar = () => {
    ...
    return ( 
        ...
        <div className='flex justify-between items-center h-16 w-fill
         text-white px-4   bg-gray-900'>
           <div>
            <Link to="/" className='text-5xl font-signature ml-2'>lo<span className='text-yellow-500'>GO</span></Link>
           </div>
